...
const NavBar = () => {
    ...
    return (
        <>
            <Container maxWidth="true" sx={{ my: 4 }} >
                <Toolbar>
                    <Box component='img' src="/insta.png" width='32px' height='auto' sx={{ display: { xs: 'none', md: 'flex' }, mr: 1, ml: 2, color: 'white' }} />
                    <Menu
                        id="menu-appbar"
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                        {pages.map((page) => (
                            <Button
                                ...
                                sx={{ mx: 3, color: 'white', display: 'block', fontSize: '16px' }}
                            >
                                {page}
                            </Button>
                        ))}
